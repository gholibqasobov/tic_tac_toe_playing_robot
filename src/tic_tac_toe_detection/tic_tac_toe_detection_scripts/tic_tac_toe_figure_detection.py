...
import time
import tic_tac_toe_detection.tictactoe_minimax_algorithm as ttt
...
def process_live_video(video_path, model_path, show_image=False, user=X, hardcode_cells=True, move_duration=2, show_yolo=False, node=None):
...
class RobotMovePublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(String, 'robot_move', 10)
        self.get_logger().info("Robot Move Publisher Node Initialized")
...
def main(args=None):
    MODEL_PATH = r"/home/qasob/tic_tac_toe_playing_robot/src/tic_tac_toe_detection/tic_tac_toe_detection/runs/detect/train3/weights/best.pt"
